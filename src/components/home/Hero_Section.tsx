...
export const Hero_Section: React.FC = () => {
  return (
    <section 
      ...
      {/* Content */}
      <div className='bg-[#FFFFFF]/80 mx-4 md:mx-0 rounded-2xl place-self-center p-3 grid place-content-center md:px-15 md:py-10'>
        <div>
          <div className='flex items-center gap-3 place-content-center place-self-center'>
            <img 
              ...
              className="w-20"
            />
            <p className='text-sm font-semibold text-[#1E1E1E]'>50K+ Satisfied Customer</p>
          </div>
          ...
          <p className='text-center font-normal text-[#323235] mt-2 text-sm font-poppins md:w-100 md:mt-4'>
