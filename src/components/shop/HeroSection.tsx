...
import herobg from "../../assets/images/shop-img.png";
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <h1 className="font-clashDisplay text-center text-[#25262A] capitalize font-medium text-3xl sm:text-4xl md:text-5xl">
            Shop from us
          </h1>
        </motion.div>
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Join us to archive our goal by building a great future for startups and big companies
        </motion.p>
