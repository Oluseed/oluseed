  ...
  return (
    <div className='grid place-content-center'>
      <div className='p-3 grid gap-y-4 mt-10 md:mt-30'>
        <h1 className='font-clashDisplay text-3xl font-medium md:text-5xl'> Unraveling Success <span className='text-[#0f04ff]'>Through Phenomenal Technology & Strategic Expertise</span></h1>
