...
export const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-[#FFFFFF]/80 mx-4 py-5 px-1  md:mx-30 md:my-20 lg:mx-70 2xl:mx-100 rounded-2xl place-self-center p-3 grid place-content-center"
      ...
      >
        ...
        <motion.p
          className="font-poppins text-[#4b4c4d] text-[12px] text-center md:text-[15px]"
          variants={itemVariants}
        >
          In a world where business survival
          depends on strategic control, 
          we empower brands with complete dominance.
          Our cutting-edge web solutions give businesses full control 
          and confidence, ensuring they stay ahead, unshaken by competitors.
        </motion.p>
